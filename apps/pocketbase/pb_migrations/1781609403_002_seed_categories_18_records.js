...
migrate((app) => {
  ...
  const record1 = new Record(collection);
    ...
    record1.set("description", "Research on vitamins, minerals, herbs, and bioactive compounds for health optimization");
    record1.set("icon", "\ud83d\udc8a");
  ...
  const record3 = new Record(collection);
    ...
    record3.set("description", "Exercise science, athletic performance, and physical training methodologies");
    record3.set("icon", "\ud83d\udcaa");
  ...
  const record4 = new Record(collection);
    ...
    record4.set("description", "Sleep science, recovery optimization, and rest-based health strategies");
    record4.set("icon", "\ud83d\ude34");
  ...
  const record5 = new Record(collection);
    ...
    record5.set("description", "Mental health, cognitive function, stress management, and emotional wellness");
    record5.set("icon", "\ud83e\udde0");
  ...
  const record7 = new Record(collection);
    ...
    record7.set("description", "Health topics specific to men's physiology and wellness");
    record7.set("icon", "\ud83d\udc68");
  ...
  const record8 = new Record(collection);
    ...
    record8.set("description", "Disease prevention, screening, and proactive health measures");
    record8.set("icon", "\ud83d\udee1\ufe0f");
  ...
  const record11 = new Record(collection);
    ...
    record11.set("description", "Science behind daily health practices and common wellness questions");
    record11.set("icon", "\ud83d\udd2c");
  ...
  const record12 = new Record(collection);
    ...
    record12.set("description", "Debunking health myths and clarifying common misconceptions");
    record12.set("icon", "\u2705");
  ...
  const record13 = new Record(collection);
    ...
    record13.set("description", "Breaking down complex scientific studies into understandable insights");
    record13.set("icon", "\ud83d\udcda");
  ...
  const record14 = new Record(collection);
    ...
    record14.set("description", "New health technologies, biotech innovations, and future of medicine");
    record14.set("icon", "\ud83d\ude80");
  ...
  const record15 = new Record(collection);
    ...
    record15.set("description", "Behavioral science, habit formation, and lifestyle optimization");
    record15.set("icon", "\ud83c\udfaf");
  ...
  const record16 = new Record(collection);
    ...
    record16.set("description", "Population health, epidemiology, and community wellness");
    record16.set("icon", "\ud83c\udf0d");
  ...
  const record17 = new Record(collection);
    ...
    record17.set("description", "Healthcare innovation, personalized medicine, and the future of health systems");
    record17.set("icon", "\ud83c\udfe5");
